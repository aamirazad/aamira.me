			...
			<section className="flex justify-center">
				<div className="max-w-4xl w-full">
					...
					<p className="mb-8 text-neutral-600 dark:text-neutral-400">
						Instead of wasting time on social media, I devote almost all of my
						free time to learning and building with what I have learned. I have
						built many projects, each more ambitious than the last in order to
						continue to push myself and prepare myself for the future.
					</p>
			...
			<section className="flex justify-center">
				<div className="max-w-4xl w-full">
					<div className="flex items-center space-x-2 mb-6">
						...
						<h2 className="text-3xl font-semibold tracking-tight">Homelab</h2>
					</div>
					<p className="mb-8 text-neutral-600 dark:text-neutral-400">
						With the purpose of teaching myself networking as well as creating
						services I use every day, I have built a homelab setup. Run on a
						network of computers from an old machine I bought on eBay to a
						raspberry pi, my infrastructure hosts thousands of gigabytes of data
						and many intensive services with{" "}
						<a
