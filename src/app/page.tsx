        ...
        <section className="flex justify-center ">
            <div className="max-w-xl">
                ...
                <p className="my-6 dark:text-slate-400 text-slate-600">
                    Instead of wasting time on social media, I devote almost all
                    of my free time to learning and building with what I have
                    learned. I have built many projects, each more ambitious
                    than the last in order to continue to push myself and
                ...
                <div className="font-sm my-6 flex flex-col space-x-0 space-y-2 text-neutral-900 dark:text-neutral-300">
                    {projects.map((item) => (
                        <div
                            key={item.href}
                            className="border-l border-slate-600 pl-1"
                        >
                ...
                <p className="my-6 dark:text-slate-400 text-slate-600">
                    With the purpose of teaching myself networking as well as
                    creating services I use every day, I have built a homelab
                    setup. Run on a network of computers from an old machine I
                    bought on ebay to a raspberry pi, my infustructure hosts
                    thousands of gigabytes of data and many intesive services
                    with
                    <a
                    ...
                    . With zero open ports, I have built a secure and reliable
                    system to support me and my family.
                </p>
                <ul className="font-sm my-6 flex flex-col space-x-0 space-y-2 text-neutral-600 dark:text-neutral-300">
                    {homelab.map((link) => (
                        <li key={link.href}>
